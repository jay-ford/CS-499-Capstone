...
export class AuthenticationService {
  ...
  // Save our token to our Storage provide
  ...
  //Retrieve current user after verified use isLoggedIn
  ...
  // Login method that leverages Observable login method in tripDataService
  ...
  // Register method that leverages Observable register methid in tripDataService
